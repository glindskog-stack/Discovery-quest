...
const I18N_STRINGS = {
  ...
  "btn.explore_go": { en: "Go ✨", sv: "Kör ✨", fr: "Go ✨", de: "Los ✨", es: "Vamos ✨" },
  "btn.explore_another": { en: "Explore another topic", sv: "Utforska ett annat ämne", fr: "Explorer un autre sujet", de: "Ein anderes Thema erkunden", es: "Explorar otro tema" },
  "btn.try_again": { en: "Try again", sv: "Försök igen", fr: "Réessayer", de: "Nochmal versuchen", es: "Intentar de nuevo" },
  ...
  "quest.landing_greeting_morning": { en: "Morning, {name}.", sv: "God morgon, {name}.", fr: "Salut {name}, bien dormi ?", de: "Morgen, {name}.", es: "Buenos días, {name}." },
  "quest.landing_greeting_afternoon": { en: "Hey {name}.", sv: "Tja {name}.", fr: "Salut {name}.", de: "Hey {name}.", es: "Hola {name}." },
  "quest.landing_greeting_evening": { en: "Evening, {name}.", sv: "God kväll, {name}.", fr: "Bonsoir {name}.", de: "Guten Abend, {name}.", es: "Buenas tardes, {name}." },
  "quest.landing_sub.0": { en: "Your brain's a little sharper than yesterday. Let's keep it that way.", sv: "Din hjärna är lite vassare än igår. Låt oss hålla det så.", fr: "Ton cerveau est un peu plus affûté qu'hier. Gardons ça comme ça.", de: "Dein Gehirn ist heute etwas schärfer als gestern. Lass es dabei bleiben.", es: "Tu cerebro está un poco más agudo que ayer. Mantengámoslo así." },
  "quest.landing_sub.1": { en: "Five minutes. That's the whole ask.", sv: "Fem minuter. Det är hela grejen.", fr: "Cinq minutes. C'est tout ce qu'on demande.", de: "Fünf Minuten. Mehr verlangen wir nicht.", es: "Cinco minutos. Eso es todo lo que pedimos." },
  "quest.landing_sub.2": { en: "One question. See where it goes.", sv: "En fråga. Se vart det leder.", fr: "Une question. On verra où ça mène.", de: "Eine Frage. Schauen wir, wohin es führt.", es: "Una pregunta. A ver a dónde lleva." },
  "quest.landing_sub.3": { en: "Nobody's grading this but you.", sv: "Ingen betygsätter det här förutom du.", fr: "Personne ne note ça, à part toi.", de: "Hier bewertet dich niemand außer dir selbst.", es: "Nadie califica esto excepto tú." },
  "quest.landing_sub.4": { en: "Your streak is waiting on you.", sv: "Din svit väntar på dig.", fr: "Ta série t'attend.", de: "Deine Serie wartet auf dich.", es: "Tu racha te está esperando." },
  "quest.landing_explore_teaser": { en: "You can learn about literally anything here — tap to explore any topic.", sv: "Du kan lära dig om precis vad som helst här — tryck för att utforska ett ämne.", fr: "Tu peux apprendre sur littéralement n'importe quoi ici — appuie pour explorer un sujet.", de: "Du kannst hier über wortwörtlich alles lernen — tippen, um ein Thema zu erkunden.", es: "Aquí puedes aprender sobre literalmente cualquier cosa — toca para explorar un tema." },
  ...
  "focus.explore_label": { en: "Explore anything", sv: "Utforska vad som helst", fr: "Explore n'importe quoi", de: "Erkunde alles", es: "Explora lo que sea" },
  "focus.explore_hint": { en: "Type literally anything — roses, a religion, fixing an old car — and get a real quiz on it in seconds.", sv: "Skriv precis vad som helst — rosor, en religion, laga en gammal bil — och få ett riktigt quiz om det på några sekunder.", fr: "Tape littéralement n'importe quoi — les roses, une religion, réparer une vieille voiture — et obtiens un vrai quiz dessus en quelques secondes.", de: "Tippe wortwörtlich irgendwas ein — Rosen, eine Religion, ein altes Auto reparieren — und bekomm in Sekunden ein echtes Quiz dazu.", es: "Escribe literalmente lo que sea — rosas, una religión, reparar un coche viejo — y consigue un quiz real sobre eso en segundos." },
  "focus.explore_placeholder": { en: "e.g. roses, Buddhism, fixing a carburetor", sv: "t.ex. rosor, buddhism, laga en förgasare", fr: "ex. les roses, le bouddhisme, réparer un carburateur", de: "z. B. Rosen, Buddhismus, einen Vergaser reparieren", es: "p. ej. rosas, budismo, reparar un carburador" },
  "focus.explore_generating": { en: "Cooking up your quiz...", sv: "Bygger ditt quiz...", fr: "Concoction de ton quiz...", de: "Dein Quiz wird gebraut...", es: "Preparando tu quiz..." },
  "focus.explore_ai_badge": { en: "✨ AI-generated", sv: "✨ AI-genererat", fr: "✨ Généré par IA", de: "✨ KI-generiert", es: "✨ Generado por IA" },
  "focus.explore_done_title": { en: "Nice work!", sv: "Snyggt jobbat!", fr: "Bien joué !", de: "Gut gemacht!", es: "¡Buen trabajo!" },
  "focus.explore_done_body": { en: "You got {score}/{total} right on {topic}.", sv: "Du fick {score}/{total} rätt om {topic}.", fr: "Tu as eu {score}/{total} bonnes réponses sur {topic}.", de: "Du hattest {score}/{total} richtig zu {topic}.", es: "Acertaste {score}/{total} sobre {topic}." },
  "focus.explore_recent_label": { en: "Jump back into", sv: "Hoppa tillbaka in i", fr: "Reprends", de: "Weiter geht's mit", es: "Retoma" },
  "focus.explore_error_unavailable": { en: "This needs a connection — try again once you're online.", sv: "Det här kräver internet — försök igen när du är uppkopplad.", fr: "Ça nécessite une connexion — réessaie une fois en ligne.", de: "Dafür brauchst du eine Verbindung — versuch's erneut, sobald du online bist.", es: "Esto necesita conexión — inténtalo de nuevo cuando estés en línea." },
  "focus.explore_error_failed": { en: "Couldn't generate that one — give it another shot.", sv: "Kunde inte skapa det där — försök igen.", fr: "Impossible de générer ça — retente ta chance.", de: "Konnte das nicht erstellen — versuch's noch mal.", es: "No se pudo generar eso — inténtalo otra vez." },
